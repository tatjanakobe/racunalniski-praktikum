...
Ta datoteka vsebuje osnove LaTeXa. Uporabite jo tako, da primerjate njeno vsebino z
 ...
 Komentarji se začnejo z znakom
  in veljajo do konca vrstice. Kar napišete v komentar,
  LaTeX ignorira.
...
Ostale možnosti za kodiranje so:
 \usepackage[cp1250]{inputenc}  
  Kodirna tabela za Windows, zastarelo
 \usepackage[latin2]{inputenc}  
  Kodirna tabela za Linux, zastarelo
...
\usepackage[T1]{fontenc}     
 izhodna datoteka je korirana v sistemu T1
...
\usepackage{lmodern}           
 Boljši fonti, s pravimi šumniki
 ...
 Palatino
 \usepackage{concrete}        
 Pisava, ki jo je uporabil Donald Knuth v knjigi "Concrete mathematics"
