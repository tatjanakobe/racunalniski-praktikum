...
\newcommand{\pisana}[2]{\mathscr{#1}_#2}
...
% Začetek magičnega kvadrata
 ...
 \begin{magic}{4}{Kvadrat Lo Shu}{table:loshu}
   4 & 9 & 2 \\\hline
   3 & 5 & 7 \\\hline
   8 & 1 & 6 \\\hline
 \end{magic}
...
Avtorja navedenega približka sta Pinn in Wieczerkowski (glej \cite{bessy, berlekamp, gardner, pinn}), ki
