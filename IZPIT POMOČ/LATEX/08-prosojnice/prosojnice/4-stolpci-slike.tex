		...
		\column{0.55\textwidth}
		  ...
		  \end{itemize}
			...
			\begin{tikzpicture}
				...
				% Premica p
				\draw[blue, very thick] (-2,0) -- (2,0) node[left] {$p$};
				\pause
				...
				\pause
				\coordinate (C') at ({\td},{\tt});
				\draw[gray, thin] (C') arc[start angle=120, end angle=240, radius=2] node[below right] {\scriptsize $n$};
				\pause
				\coordinate [label={[blue, below left]:$C$}] (C) at (0,{-\t});
